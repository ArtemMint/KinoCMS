...
class FilmForm(forms.ModelForm):
    ...
    class Meta:
        model = Film
        fields = ('name', 'year', 'country', 'director', 'producer', 'music', 'scenarist', 'genre',
                  'description', 'preview', 'video', 'image1', 'image2', 'image3', 'image4', 'image5')
        widgets = {
...
class CinemaForm(forms.ModelForm):
    ...
    class Meta:
        model = Cinema
        fields = ('name', 'description', 'preview', 'image1',
...
class NewsForm(forms.ModelForm):
    ...
    class Meta:
        model = News
        fields = ('name', 'description', 'status', 'preview', 'image1', 'image2', 'image3',
                  'image4', 'image5', 'video', 'seo_title', 'seo_keywords', 'seo_description')
        widgets = {
