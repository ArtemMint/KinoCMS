...
urlpatterns = [
    ...
    path('vip-hall/',
         ...
         name='vip_hall'),
    path('advertising/',
         advertising_page_view,
         name='advertising'),
    path('contacts/',
         contacts_page_view,
         name='contacts'),
    path('mobile_app/',
         mobile_app_page_view,
         name='mobile_app'),
    path('about/',
         children_room_page_view,
         name='about'),
    ...
    path('admin/banners/sliders/',
         slider_banners_update,
         name='admin_banners_sliders'),
    path('admin/banners/background/',
         back_banners_update,
         name='admin_banners_back'),
    path('admin/banners/shares/',
         shares_banners_update,
         name='admin_banners_shares'),
    path('admin/shares/',
         AdminSharesView.as_view(),
         name='admin_shares'),
    path('admin/pages/',
         admin_pages_view,
         name='admin_pages'),
    path('admin/pages/ads/',
         admin_ads_view,
         name='admin_ads'),
    path('admin/pages/home/',
         admin_home_page_view,
         name='admin_homepage'),
    path('admin/pages/contacts/',
         admin_contacts_page_view,
         name='admin_contacts_page'),
    path('admin/pages/cafe-bar/',
         admin_cafe_bar_page_view,
         name='admin_cafe-bar_page'),
    path('admin/pages/vip-hall/',
         admin_vip_hall_page_view,
         name='admin_vip-hall_page'),
    path('admin/pages/advertising/',
         admin_advertising_page_view,
         name='admin_advertsing_page'),
    path('admin/pages/children_room/',
         admin_children_room_page_view,
         name='admin_children_room_page'),
    path('admin/pages/mobile_app/',
         admin_mobile_app_page_view,
         name='admin_mobile_app_page'),

    # Mailing of users.
    path('admin/mailing/all/',
         mailing_all_users,
         name='mailing_all_users'),
    path('admin/mailing/group/',
         mailing_group_of_users,
         name='mailing_group_of_users'),

    # Admin films.
    path('admin/films/',
         AdminFilmsView.as_view(),
         name='admin_films'),
    path('admin/films/create/',
         admin_film_create_view,
         name='admin_create_film'),
    path('admin/films/<int:film_id>',
         admin_film_detail_view,
         name='admin_film_detail'),
    path('admin/films/<int:film_id>/update/',
         admin_film_update_view,
         name='admin_update_film'),
    path('admin/films/<int:pk>/delete',
         AdminFilmDeleteView.as_view(),
         name='admin_delete_film'),

    # Admin cinemas.
    path('admin/cinemas/',
         AdminCinemasView.as_view(),
         name='admin_cinemas'),
    path('admin/cinemas/create/',
         admin_cinema_create_view,
         name='admin_create_cinema'),
    path('admin/cinemas/<int:cinema_id>/',
         admin_cinema_detail_view,
         name='admin_cinema_detail'),
    path('admin/cinemas/<int:cinema_id>/update/',
         admin_cinema_update_view,
         name='admin_update_cinema'),
    path('admin/cinemas/<int:pk>/delete/',
         AdminCinemaDeleteView.as_view(),
         name='admin_delete_cinema'),

    # Admin cinema hall.
    path('admin/cinemas/<int:cinema_id>/cinemahall/create/',
         admin_cinemahall_create_view,
         name='admin_add_cinemahall'),
    path('admin/cinemas/<int:cinema_id>/cinemahall/<int:cinemahall_id>/',
         admin_cinemahall_detail_view,
         name='admin_cinemahall_detail'),
    path('admin/cinemas/<int:cinema_id>/cinemahall/<int:cinemahall_id>/update/',
         admin_cinemahall_update_view,
         name='admin_update_cinemahall'),
...
#          name='admin_cinemahall_type_add'),
    ...
    # Admin news.
    path('admin/news/',
         AdminNewsView.as_view(),
         name='admin_news'),
    path('admin/news/create/',
         admin_news_create_view,
         name='admin_create_news'),
    path('admin/news/<int:news_id>',
         admin_news_detail_view,
         name='admin_news_detail'),
    path('admin/news/<int:news_id>/update/',
         admin_news_update_view,
         name='admin_update_news'),
    ...
    path('admin/shares/create/',
         admin_shares_create_view,
         name='admin_create_shares'),
    path('admin/shares/<int:shares_id>',
         admin_shares_detail_view,
         name='admin_shares_detail'),
    path('admin/shares/<int:shares_id>/update/',
         admin_shares_update_view,
         name='admin_update_shares'),
    path('admin/shares/<int:pk>/delete',
         AdminSharesDeleteView.as_view(),
         name='admin_delete_shares'),
